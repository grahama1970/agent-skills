# Graham Anderson
Buffalo, NY | Buffalo-area hybrid/onsite or remote | [graham@grahama.co](mailto:graham@grahama.co) | [LinkedIn](https://www.linkedin.com/in/grahamanderson/) | [GitHub](https://github.com/grahama1970) | [PDF](docs/resume/graham-anderson-resume.pdf)
...
From simulated worlds to mission-critical verifiable AI: Executive Producer on the God of War: Ascension interactive campaign (Real Pie, for Sony; Webby-recognized), leading 80+ person interactive productions; before that, commercial composer for major consumer brands (Adidas, Pepsi, X-Games). Creative systems thinking is why my AI systems are architected, not stapled together.
