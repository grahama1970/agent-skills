...
```json
{
  ...
  "source_paths": [
    ...
    "skills/watch/ui/scripts/watchYoloHandoffStopBroad.smoke.ts",
    "skills/watch/docs/architecture/generated/bad_santa_marcus_0248_evidence_case_live/watch_evidence_case_live_filing_receipt.json"
  ],
