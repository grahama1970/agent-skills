...
def list_sources():
    ...
    for s in config.sources:
        ...
        elif s.type == SourceType.GITHUB: details = f"{s.gh_owner}/{s.gh_repo} (not yet implemented)"
        elif s.type == SourceType.NVD: details = f"Query: {s.nvd_query} (not yet implemented)"
