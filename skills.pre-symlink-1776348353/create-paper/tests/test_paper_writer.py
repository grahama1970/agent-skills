...
from draft import generate_draft_pipeline as generate_draft
from utils import sanitize_prompt_injection, log_ai_usage, AI_USAGE_LEDGER
from citations import verify_arxiv_id, verify_doi, check_citations
...
class TestCitationVerification:
    ...
    @patch("citations.httpx.get")
    def test_verify_arxiv_id_valid(self, mock_get):
    ...
    @patch("citations.httpx.get")
    def test_verify_arxiv_id_invalid(self, mock_get):
    ...
    @patch("citations.httpx.get")
    def test_verify_doi_valid(self, mock_get):
    ...
    @patch("citations.httpx.get")
    def test_verify_doi_not_found(self, mock_get):
