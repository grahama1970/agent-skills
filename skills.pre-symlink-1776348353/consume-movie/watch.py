...
def main(
    movie: Optional[str] = typer.Option(None, help="Movie ID to watch"),
    book: Optional[str] = typer.Option(None, help="Specific book ID for context"),
    search: Optional[str] = typer.Option(None, help="Search for scenes matching query"),
    list: bool = typer.Option(False, help="List available movies"),
    ...
    with_book_context = with_book_context and not no_book_context
