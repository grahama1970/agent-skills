"""Probe registry, runner, and core data types for monitor-taxonomy.

Defines ProbeResult dataclass, ProbeStatus enum, the probe registry
that maps probe names to their implementation functions, and run_probes().

Inputs: tier/probe filters from CLI.
Outputs: list of ProbeResult from executed probes.
"""
...
# Tier mapping: CLI uses 0=all, 15=tier1.5, 2=tier2
_TIER_MAP = {0: None, 15: 15, 2: 2}
...
def register_probe(
    ...
    Tier values: 0 = heuristic, 15 = classifier/GPT, 2 = teacher.
    """
...
def run_probes(
    ...
    from probes import tier0_quality, tier15_classifier, tier2_teacher  # noqa: F401
