...
- run_id: `review_pdf_1771950239`
- documents_total: `1`
- documents_analyzed: `1`
- documents_missing: `0`
- overall_average_score: `0.7143`
...
## top issue codes
- content_overextract_medium: `1`

## recommended helper skills
- none

## aggregate helper jobs
- [quality-audit] `cd /home/graham/workspace/experiments/pi-mono/.pi/skills/quality-audit && ./run.sh report --input reports/review_pdf_1771950239/per_doc --output reports/review_pdf_1771950239/quality_audit.md`
...
- [analytics] `cd /home/graham/workspace/experiments/pi-mono/.pi/skills/analytics && ./run.sh describe reports/review_pdf_1771950239/aggregate.json`
