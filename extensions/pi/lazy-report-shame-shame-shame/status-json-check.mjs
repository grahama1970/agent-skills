...
function crossProviderReviewReason(status) {
  ...
  if (data.generated_by !== 'pi-subagents') return reject('cross-provider review proof was not generated by pi-subagents', 'invalid');
  ...
  if (meta.generated_by !== 'pi-subagents') return reject('cross-provider review metadata was not generated by pi-subagents', 'invalid');
