...
# Model mapping (updated Feb 2026)
# See: https://docs.perplexity.ai/getting-started/models
# Note: sonar-reasoning was deprecated Dec 15, 2025 → use sonar-reasoning-pro
MODELS = {
    "small": "sonar",               # Fast, good for simple queries
    "large": "sonar-pro",           # Better quality, more thorough
    "huge": "sonar-reasoning-pro",  # Best for complex analysis (DeepSeek-R1 based)
}
