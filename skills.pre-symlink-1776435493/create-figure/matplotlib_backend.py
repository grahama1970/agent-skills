...
def generate_metrics_chart(
    ...
    if canvas:
        ...
        html = matplotlib_to_canvas(title=title, source="/create-figure metrics")
...
def generate_heatmap(
    ...
    if canvas:
        from canvas import matplotlib_to_canvas
        html = matplotlib_to_canvas(title=title, source="/create-figure heatmap")
        output_path.with_suffix(".html").write_text(html)
        return True
...
def generate_radar_chart(
    ...
    if canvas:
        from canvas import matplotlib_to_canvas
        html = matplotlib_to_canvas(title=title, source="/create-figure radar")
        output_path.with_suffix(".html").write_text(html)
        return True
