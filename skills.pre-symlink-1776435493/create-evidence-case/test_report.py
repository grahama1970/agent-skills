...
"""Tests for report.py in the v5 restructured pipeline."""
...
def test_render_markdown_report_core_sections(golden_case):
    ...
    # v5 uses icon prefix: "## ✓ Answerable: YES"
    assert "Answerable: YES" in md
    # v5 collapses gates into <details>, proof into one-liner
    assert "Gates" in md
...
def test_render_proof_result_uses_nested_proof_data():
    ...
    assert "theorem t : True := by trivial" in section
