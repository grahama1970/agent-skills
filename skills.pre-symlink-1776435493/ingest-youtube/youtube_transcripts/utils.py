...
def create_webshare_proxy_config(proxy_settings: dict) -> "WebshareProxyConfig":
    """Create a WebshareProxyConfig for youtube-transcript-api.

    Uses the native first-class Webshare integration — rotation, session
    handling, and endpoint config are all handled automatically.

    Args:
        proxy_settings: Dict with username, password, and optional countries list.

    Returns:
        WebshareProxyConfig instance
    """
