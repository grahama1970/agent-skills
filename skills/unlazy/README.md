...
The current source targets `2.1.0`. It is not identified here as a tagged GitHub release. This vendored copy is pinned in [PROVENANCE.md](PROVENANCE.md).
...
Contributor history and pull-request links remain in the upstream repository history. This vendored copy records its import commit in [PROVENANCE.md](PROVENANCE.md).
