...
Explain the failure, the contract after the change, and the exact regression evidence. Keep unrelated refactors out of the patch. For this vendored copy, record import or local customization provenance in `PROVENANCE.md` when it changes the skill contract.
