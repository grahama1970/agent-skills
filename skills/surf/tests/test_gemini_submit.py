...
def test_gemini_submit_uses_requested_tab_id_when_upstream_omits_metadata(tmp_path: Path) -> None:
...
case "${1:-}" in
  focus.state)
    printf '{"focusedWindowId":1,"activeTabId":837360887}\\n'
    ;;
  gemini_tab)
...
""",
    ...
    assert payload["controlled_tab_id"] == "837360887"
