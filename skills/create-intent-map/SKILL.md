...
System prompts for intent mapping SFT data MUST be validated through `/prompt-lab` before training. NEVER hand-craft system prompts in Python strings.

- Before training: `/prompt-lab eval` the QuerySpec system prompt against ground truth
