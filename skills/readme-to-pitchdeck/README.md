...
./run.sh build \
  ...
  --output /mnt/storage12tb/skills/readme-to-pitchdeck/outputs/product-public.pptx
```
...
./run.sh build \
  ...
  --output /mnt/storage12tb/skills/readme-to-pitchdeck/outputs/sparta-public.pptx \
  --require-approved-claims
```
