...
def find_inbox_tool() -> Optional[Path]:
    ...
    skills_root = Path(__file__).resolve().parent.parent.parent.parent.parent
    candidates = [
        skills_root / "fetcher" / ".agents" / "skills" / "agent-inbox" / "run.sh",
        skills_root / "agent-inbox" / "run.sh",
