...
def watch(
    ...
    diarization: str = typer.Option("auto", "--diarization", help="Speaker diarization mode: auto, pyannote, or none"),
    num_speakers: Optional[int] = typer.Option(None, "--num-speakers", help="Exact speaker count for diarization"),
    min_speakers: Optional[int] = typer.Option(None, "--min-speakers", help="Minimum speaker count for diarization"),
    max_speakers: Optional[int] = typer.Option(None, "--max-speakers", help="Maximum speaker count for diarization"),
    require_diarization: bool = typer.Option(False, "--require-diarization", help="Return nonzero when requested diarization fails"),
