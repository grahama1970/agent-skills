...
import type { LoadedCalthArtifacts } from "./artifacts";
...
function createReceipt(data: LoadedCalthArtifacts, text: string): BattleHumanInterjection {
...
export function BattleChatSidebar({ data }: { data: LoadedCalthArtifacts }) {
