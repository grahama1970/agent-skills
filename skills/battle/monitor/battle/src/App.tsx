...
function PlayerCard({ player }: { player: BattlePlayer }) {
  return (
...
function TimelineNode({ item }: { item: BattleTimelineStage }) {
  return (
...
function ScoreCard({ data }: { data: LoadedBattleArtifacts }) {
...
function EvidencePanel({ data }: { data: LoadedBattleArtifacts }) {
  return (
    <section className="card">
      <div className="cardHeader">
        <div className="iconBadge">
