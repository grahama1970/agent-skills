...
# Check module files
MODULES="config.py state.py memory.py scoring.py digital_twin.py red_team.py blue_team.py orchestrator.py report.py qemu_support.py qemu_peripherals.py"
