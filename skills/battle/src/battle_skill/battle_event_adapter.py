...
def exploit_lifecycle_dag() -> dict[str, Any]:
    ...
    return {
        ...
        "scenario_coverage": [
            ...
            {
                "battle_id": "battle-006",
                "cwe": "CWE-502",
                "exploit_class": "deserialization_gadget",
                "fixture": "fresh_arena_pickle_deserialization",
                "normalized_fixture": "local/battle-006-pickle-deserialization.normalized.json",
                "transport_stream": "local/battle-006-pickle-deserialization-stream",
                "public_fixture": "spectator/public/battle-fixtures/battle-006-pickle-deserialization-pixi-replay/battle.normalized_ux_fixture.json",
            },
            {
                "battle_id": "battle-007",
                "cwe": "CWE-434",
                "exploit_class": "file_upload_probe",
                "fixture": "fresh_arena_file_upload",
                "normalized_fixture": "local/battle-007-file-upload.normalized.json",
                "transport_stream": "local/battle-007-file-upload-stream",
                "public_fixture": "spectator/public/battle-fixtures/battle-007-file-upload-pixi-replay/battle.normalized_ux_fixture.json",
            },
        ],
        "nodes": nodes,
        "edges": edges,
