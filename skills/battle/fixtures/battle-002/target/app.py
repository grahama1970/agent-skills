"""Tiny vulnerable web app for the Battle subagent smoke fixture.

The entry point is ``GET /search?q=<term>``. The fixture intentionally combines
unsafe SQL string formatting with unsafe HTML reflection so one Red attempt can
prove both SQL injection and XSS before Blue applies the deterministic patch.
"""
