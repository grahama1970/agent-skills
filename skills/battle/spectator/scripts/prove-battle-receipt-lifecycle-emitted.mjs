...
record('1-child-knowledge-packet-emitted', childKnowledge.includes('inherited') && !childKnowledge.includes('not emitted'), childKnowledge)
record('2-child-memory-promotion-emitted', childMemory.includes('not promoted') && !childMemory.includes('not emitted'), childMemory)
record('3-child-score-calibration-emitted', childScore.length > 0 && !childScore.includes('not emitted'), childScore)
record('4-child-network-summary-honest', childNetwork.includes('false'), childNetwork)
...
record('5-parent-spawn-request-emitted', parentSpawn.length > 0 && !parentSpawn.includes('not emitted'), parentSpawn)
record('6-parent-tau-branch-emitted', parentTau.length > 0 && !parentTau.includes('not emitted'), parentTau)
record('7-parent-knowledge-packet-emitted', parentKnowledge.includes('materialized') && !parentKnowledge.includes('not emitted'), parentKnowledge)
