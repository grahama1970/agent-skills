...
export function SynthesisClaimBoundaryPanel({
	model,
	focused,
}: {
	model: SynthesisViewModel["claimBoundary"];
	focused?: boolean;
}) {
	...
	return (
		<section className="battle-proof-panel" data-qid="battle:synthesis:claim-boundary" data-focused={focused ? "true" : undefined}>
			...
			<div className="mt-3 grid gap-3 md:grid-cols-2">
				{showMay ? (
					<div className="rounded-lg border border-emerald-400/20 bg-emerald-400/5 p-3" data-qid="battle:synthesis:claim-may">
				...
				{showMustNot ? (
					<div className="rounded-lg border border-rose-400/20 bg-rose-400/5 p-3" data-qid="battle:synthesis:claim-must-not">
