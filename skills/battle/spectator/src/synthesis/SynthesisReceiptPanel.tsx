...
export function SynthesisReceiptPanel({
	receipts,
	focused,
}: {
	receipts: SynthesisViewModel["receipts"];
	focused?: boolean;
}) {
	return (
		<section className="battle-proof-panel" data-qid="battle:synthesis:receipts" data-focused={focused ? "true" : undefined}>
