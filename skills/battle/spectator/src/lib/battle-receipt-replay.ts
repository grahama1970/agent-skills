...
export const BATTLE_RECEIPT_REPLAY_FIXTURE_URLS = {
	...
	"battle-004-parent-spawn-lifecycle": "/battle-fixtures/battle-004-parent-spawn-lifecycle-pixi-replay/battle.normalized_ux_fixture.json",
	...
	"battle-004-adaptive-lineage-live": "/battle-fixtures/battle-004-adaptive-lineage-live/battle.normalized_ux_fixture.json",
} as const;
