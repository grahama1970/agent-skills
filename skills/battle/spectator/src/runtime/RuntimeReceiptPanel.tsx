...
export function RuntimeReceiptPanel({
	receipts,
	focused,
}: {
	receipts: RuntimeViewModel["receipts"];
	focused?: boolean;
}) {
	return (
		<section className="battle-proof-panel" data-qid="battle:runtime:receipts" data-focused={focused ? "true" : undefined}>
