...
def run_live_e2e(
    ...
    cooldown_seconds: int = typer.Option(3600, "--cooldown-seconds", min=0, help="Confirmed prompt cooldown passed to tick."),
    unconfirmed_cooldown_seconds: int = typer.Option(600, "--unconfirmed-cooldown-seconds", min=0, help="Unconfirmed prompt cooldown passed to tick."),
    ...
    command = [
        ...
        "--unconfirmed-cooldown-seconds",
        str(unconfirmed_cooldown_seconds),
        "--max-prompts",
        "1",
        "--json",
    ]
