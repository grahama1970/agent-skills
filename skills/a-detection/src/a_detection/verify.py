...
from a_detection.contracts import EvidenceExport, ReplayVerification
...
def verify_export(export: EvidenceExport) -> dict:
    ...
    return ReplayVerification.model_validate({"schema_version": "a_detection.replay_verification.v1", "status": "PASS",
