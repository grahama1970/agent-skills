...
export const EMBRY = {
	...
	bgCard: "#1a1a1a",
	bgPanel: "#111111",
	// sparta#47: defers to the semantic authority in styles/design-tokens.css.
	// (Was #0b1220, which disagreed with the design-intent void #090c10.)
	// Safe as a CSS value; EMBRY status colors (green/red/amber) stay literal
	// because call sites concatenate alpha suffixes and canvas cannot resolve var().
	bgDeep: "var(--surface-deep)",
	bgHeader: "#0f172a",
