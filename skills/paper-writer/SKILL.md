...
paper-writer domains

# Filter commands by domain
paper-writer list --domain generate    # Paper generation commands
paper-writer list --domain verify      # Quality assurance commands
paper-writer list --domain comply      # Venue compliance commands

# Get workflow recommendations based on paper stage
paper-writer workflow --stage new_paper
paper-writer workflow --stage pre_submission

# Show fixture-graph presets for figures
paper-writer figure-presets
```
...
```bash
paper-writer domains --summary          # JSON of all domains
paper-writer workflow --stage new_paper --summary  # JSON recommendations
paper-writer figure-presets --summary   # JSON of IEEE sizes + colormaps
```
