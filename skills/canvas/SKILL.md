...
name: canvas
description: >
  Create standalone IDE canvas artifacts for structured analysis, reports,
  charts, and tables when the output should be viewed beside the chat.
provides:
  - ide-canvas-artifact-guidance
  - canvas-design-quality-guidance
composes: []
metadata:
  surfaces:
    - ide
