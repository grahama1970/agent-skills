...
def cmd_check(args):
    ...
    print("[arango-ops] Running health checks...")
...
def cmd_embeddings(args):
    ...
    print("[arango-ops] Checking embeddings...")
...
def cmd_duplicates(args):
    ...
    print("[arango-ops] Checking duplicates...")
...
def cmd_orphans(args):
    ...
    print("[arango-ops] Checking orphaned edges...")
...
def cmd_integrity(args):
    ...
    print("[arango-ops] Checking integrity...")
...
def cmd_stats(args):
    ...
    print("[arango-ops] Gathering stats...")
    result = get_stats(db)
...
def cmd_full(args):
    ...
    print("[arango-ops] Running full maintenance...")
    report = MaintenanceReport()
