...
"""
Tests for fixture-graph skill (modularized version).
...
from utils import (
    check_graphviz as _check_graphviz,
    check_mermaid as _check_mermaid,
    check_matplotlib as _check_matplotlib,
    check_networkx as _check_networkx,
)
