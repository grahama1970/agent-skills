...
forwarded by researchers, then push to create-paper/dogpile via webhooks.
...
logger = logging.getLogger("ops-discord")
...
class KeywordMatch:
    ...
    def to_webhook_payload(self) -> dict:
        """Format for create-paper/dogpile webhook."""
        return {
            "source": "discord",
...
def version():
    ...
    console.print("ops-discord v0.2.0 (Notification Monitor Model)")
