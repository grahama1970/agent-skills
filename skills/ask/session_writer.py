...
sessions. Personas and humans use the same format — the only difference is
the scope and persona_id fields.

Sessions are written to ASK_SESSION_DIR (default: ~/.pi/sessions/ask/) and
registered with /episodic-archiver for archival and analysis.
"""
