...
const cases = {
  ...
  'content-after-json': { expect: 'pass', reason: null, text: report({ trailing: '\nOne more sentence after the status block.' }) },
  'second-fence-after-json': { expect: 'pass', reason: null, text: report({ trailing: '\n```text\nextra\n```' }) },
  ...
  'trailing-html-comment-after-json': { expect: 'pass', reason: null, text: report({ trailing: '\n<!-- trailing payload -->' }) },
  'trailing-reference-after-json': { expect: 'pass', reason: null, text: report({ trailing: '\n[ref]: hidden trailing payload' }) },
  'trailing-template-after-json': { expect: 'pass', reason: null, text: report({ trailing: '\n<template>hidden trailing payload</template>' }) },
  'status-report-after-json': { expect: 'pass', reason: null, text: `${jsonOnly()}\n\nStatus Report\n- Goal: adversarial status report probe\n- State: done` },
