...
from ai_detection.contracts import (
    Analysis,
    Deletion,
    Edit,
    EventReceipt,
...
from ai_detection.io import canonical, digest, strict_json, text_digest
from ai_detection.model import ModelArtifact
...
class Store:
    ...
    def create(self, request: SessionRequest) -> dict:
        ...
        return SessionCreated.model_validate({"schema_version": "ai_detection.session_created.v1", "session_id": identifier,
    ...
    def append(self, session_id: str, token: str, event: Edit) -> EventReceipt:
        ...
        with self.transaction() as db:
            ...
            payload = {"schema_version": "ai_detection.event_receipt.v1", "session_id": session_id,
