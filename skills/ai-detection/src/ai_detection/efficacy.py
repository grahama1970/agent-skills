...
from ai_detection.contracts import Policy, Sha256, Strict
from ai_detection.dataset import audit_splits, load_records
from ai_detection.errors import Code, DetectionError
from ai_detection.model import evaluate, load_model, predict, session_scores
from ai_detection.statistics import rates


class EfficacyRequest(Strict):
    schema_version: Literal["ai_detection.efficacy_request.v1"] = "ai_detection.efficacy_request.v1"
    corpus: str
    model: str
    model_sha256: Sha256
...
class EfficacyReport(Strict):
    schema_version: Literal["ai_detection.efficacy_numeric_gate.v1"] = "ai_detection.efficacy_numeric_gate.v1"
