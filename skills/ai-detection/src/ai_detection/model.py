...
from ai_detection.contracts import Sha256, Strict
from ai_detection.dataset import Record, audit_splits
from ai_detection.errors import Code, DetectionError
from ai_detection.features import FEATURE_VERSION, FEATURE_WIDTH, extract
from ai_detection.io import atomic_json, canonical, digest, read_json, utc_now
from ai_detection.statistics import choose_threshold, rates, upper_binomial
...
class ModelArtifact(Strict):
    schema_version: Literal["ai_detection.linear_model.v1"] = "ai_detection.linear_model.v1"
...
def evaluate(model: ModelArtifact, records: list[Record]) -> dict:
    ...
    return {
        "schema_version": "ai_detection.benchmark.v1", "model_sha256": model_digest(model),
