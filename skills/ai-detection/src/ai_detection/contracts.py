...
class Policy(Strict):
    schema_version: Literal["ai_detection.policy.v1"] = "ai_detection.policy.v1"
...
class EventReceipt(Strict):
    schema_version: Literal["ai_detection.event_receipt.v1"] = "ai_detection.event_receipt.v1"
...
class Analysis(Strict):
    schema_version: Literal["ai_detection.analysis.v1"] = "ai_detection.analysis.v1"
...
class EvidenceExport(Strict):
    schema_version: Literal["ai_detection.session_export.v1"] = "ai_detection.session_export.v1"
    session_id: Identifier
    language: str
    created_at: float
    expires_at: float
...
class Health(Strict):
    schema_version: Literal["ai_detection.health.v1"] = "ai_detection.health.v1"
...
class SessionCreated(Strict):
    schema_version: Literal["ai_detection.session_created.v1"] = "ai_detection.session_created.v1"
    session_id: Identifier
...
class Deletion(Strict):
    schema_version: Literal["ai_detection.deletion.v1"] = "ai_detection.deletion.v1"
...
class ReplayVerification(Strict):
    schema_version: Literal["ai_detection.replay_verification.v1"] = "ai_detection.replay_verification.v1"
