...
uv run --project "$SCRIPT_DIR" python -m py_compile scripts/monitor_confused_agents.py scripts/herdr_terminal_control.py scripts/cron_support.py scripts/transcript_classifier.py scripts/goal_discovery.py scripts/prompt_builder.py
uv run --project "$SCRIPT_DIR" pytest -q tests/test_monitor_confused_agents.py evals/test_real_world_e2e.py
