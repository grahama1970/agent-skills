...
uv run --project "$SCRIPT_DIR" python -m py_compile scripts/monitor_confused_agents.py scripts/herdr_terminal_control.py scripts/cron_support.py scripts/transcript_classifier.py scripts/goal_discovery.py
