#!/usr/bin/env python3
"""
Task-monitor integration for compliance-ops.
...
class ComplianceMonitor:
    ...
    # Local state file
    state_file: Path = field(default_factory=lambda: Path.home() / ".pi" / "task-monitor" / "compliance-ops-state.json")
...
def create_monitor(name: str = "compliance-ops") -> ComplianceMonitor:
