...
"""
    ...
    def evaluate_iteration(self, iteration: int, checkpoint_path: str) -> IterationResult:
        ...
        result = IterationResult(
            ...
            training_loss=0.0,  # Stub: extract from training logs — see checkpoint_path for real loss
...
app = typer.Typer(help="Iterative TTS Training Loop with Optional Hyperparameter Search")


@app.command()
def main(
    model_path: str = typer.Option(..., help="Base model path"),
    data: str = typer.Option(..., help="Training data JSONL"),
    output: str = typer.Option(..., help="Output directory"),
    max_iterations: int = typer.Option(5, help=""),
    quality_threshold: float = typer.Option(3.5, help=""),
    eval_phrases: str = typer.Option(None, help=""),
    epochs_per_iteration: int = typer.Option(1, help=""),
    auto_evaluate: bool = typer.Option(False, help=""),
    run_hyperparameter_search: bool = typer.Option(False, help="Run Bayesian hyperparameter search before training"),
    hp_trials: int = typer.Option(10, help=""),
    hyperparams: str = typer.Option(None, help=""),
):
