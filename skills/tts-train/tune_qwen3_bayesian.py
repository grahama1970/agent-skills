...
def main(
    n_trials: int = typer.Option(10, help="Number of trials to run"),
    n_smoke_steps: int = typer.Option(200, help="Steps per smoke test"),
    study_name: str = typer.Option("qwen3_tts_optimization", help="Optuna study name"),
):
