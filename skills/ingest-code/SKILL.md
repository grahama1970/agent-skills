...
Python functional-knowledge function and class declarations use the same
...
repository-relative file identity, and canonical source ranges when available,
while retaining the bare `symbol_name`, `symbol:<name>` lexical term, and
existing tags.
