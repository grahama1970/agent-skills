...
def test_federal_records_carry_mandate_hits_and_signal() -> None:
    ...
    assert ai["recommended_funnel"] == "consulting"
    assert ai["recommended_funnel_url"] == "https://grahama.co"
...
def test_commercial_prospects_from_lane_c() -> None:
    ...
    assert p[0]["recommended_funnel"] == "consulting"
    assert p[0]["recommended_funnel_url"] == "https://grahama.co"
