# Nightly Health Report — 2026-04-11

**Summary**: 4 ERRORS, 92 warnings

## Skills CI: 4 errors, 92 warnings
...
- **python.argparse** (5): classifier-lab, classifier-lab, classifier-lab, embedding, ingest-sparta
