# Nightly Health Report — 2026-04-15

**Summary**: 5 ERRORS, 127 warnings

## Skills CI: 5 errors, 127 warnings
- **runtime.vague_triggers** (35): anvil, argue, batch-quality, battle, bootcamp +30 more
- **subprocess.venv_leak** (13): battle, code-runner, create-evidence-case, dum-dum, embedding +8 more
- **python.file_length** (13): checkpoint, code-runner, code-runner, create-evidence-case, create-evidence-case +8 more
...
- **subprocess.stderr_fatal** (4): classifier-lab, classifier-lab, code-runner, skills-ci
