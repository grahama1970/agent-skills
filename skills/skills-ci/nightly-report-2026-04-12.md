# Nightly Health Report — 2026-04-12

**Summary**: 5 ERRORS, 120 warnings

## Skills CI: 5 errors, 120 warnings
- **runtime.vague_triggers** (35): anvil, argue, batch-quality, battle, bootcamp +30 more
- **python.file_length** (12): checkpoint, code-runner, create-evidence-case, create-evidence-case, create-qras +7 more
- **subprocess.venv_leak** (11): battle, dum-dum, embedding, extractor, hack +6 more
...
- **skills.memory_read_directive** (4): best-practices-skills, code-review-runner, create-qras, monitor-misuse
- **subprocess.stderr_fatal** (4): classifier-lab, classifier-lab, match-requirement, skills-ci
- **deps.undeclared_import** (4): classifier-lab, embedding, embedding, pdf-lab
- **naming.noun_only** (4): code-review-runner, dum-dum, match-requirement, remote-control
