...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/sync-sites/SKILL.md | Skill name 'sync-sites' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
