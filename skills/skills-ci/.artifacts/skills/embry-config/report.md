...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/embry-config/SKILL.md | Skill name 'embry-config' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
