...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/export-oscal/SKILL.md | Skill name 'export-oscal' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
