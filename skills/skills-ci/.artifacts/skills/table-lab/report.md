...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/table-lab/SKILL.md | Skill name 'table-lab' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
