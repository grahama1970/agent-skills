# Skills CI Report: embry-dashboard
...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/embry-dashboard/SKILL.md | Skill name 'embry-dashboard' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
