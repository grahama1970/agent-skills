...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/cui-marker/SKILL.md | Skill name 'cui-marker' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
