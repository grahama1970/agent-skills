# Skills CI Report: compliance-timeline
...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/compliance-timeline/SKILL.md | Skill name 'compliance-timeline' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
