# Skills CI Report: train-persona
...
|---------|------|------|---------|---------|---------|
| warn | python.module_docstring | /home/graham/workspace/experiments/pi-mono/.pi/skills/train-persona/scripts/__init__.py | Missing module docstring. | true | false |
