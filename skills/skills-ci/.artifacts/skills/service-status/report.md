# Skills CI Report: service-status
...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/service-status/SKILL.md | Skill name 'service-status' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
