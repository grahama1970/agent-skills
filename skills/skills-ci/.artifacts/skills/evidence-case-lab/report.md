# Skills CI Report: evidence-case-lab
...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/evidence-case-lab/SKILL.md | Skill name 'evidence-case-lab' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
