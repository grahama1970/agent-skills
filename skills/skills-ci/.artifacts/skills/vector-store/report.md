...
|---------|------|------|---------|---------|---------|
| warn | python.module_docstring | /home/graham/workspace/experiments/pi-mono/.pi/skills/vector-store/server.py | Missing module docstring. | true | false |
