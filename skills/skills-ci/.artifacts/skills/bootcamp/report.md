...
|---------|------|------|---------|---------|---------|
| warn | naming.noun_only | /home/graham/workspace/experiments/pi-mono/.pi/skills/bootcamp/SKILL.md | Skill name 'bootcamp' appears noun-only; consider a verb- prefix or add to _NOUN_ALLOWLIST. | false | false |
