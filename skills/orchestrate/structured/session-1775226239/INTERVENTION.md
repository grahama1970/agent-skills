...
- `1`: Express endpoint: GET /api/posture/frameworks — per-framework compliance percentages (code-runner/0)
- `2`: Express endpoint: GET /api/posture/families/:framework — control family breakdown (code-runner/0)
- `3`: Express endpoints: GET /api/posture/gaps + /api/posture/risks + /api/posture/alerts (code-runner/0)
- `4`: Express endpoint: GET /api/posture/overview — 5ft landing page aggregated data (code-runner/0)
