...
index f7ab8b5a..f3711f53 100644
...
@@ -198,58 +88,27 @@ export function usePostureData(): UsePostureDataResult {
 			setError(null);
...
@@ -257,97 +116,19 @@ export function usePostureData(): UsePostureDataResult {
 		};
