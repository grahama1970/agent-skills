...
index ef566867..780796be 100644
...
@@ -12,20 +12,11 @@ function toActionToken(value: string) {
...
+      style={{ ...card, background: EMBRY.bgCard, padding: 10, border: `1px solid ${EMBRY.border}`, display: 'grid', placeItems: 'center', gap: 6, cursor: 'pointer' }}
     >
       <svg width={80} height={80} viewBox="-40 -40 80 80" role="img" aria-label={`${framework} ${safePct}%`}>
         {arcs.map((a) => (
@@ -73,12 +55,10 @@ export default function PostureDashboard({ onNavigateToControl }: Props) {
...
@@ -93,19 +73,7 @@ export default function PostureDashboard({ onNavigateToControl }: Props) {
...
@@ -122,157 +90,126 @@ export default function PostureDashboard({ onNavigateToControl }: Props) {
