...
def generate_figures(
    ...
    # 3. Workflow diagram (create-paper 5-stage workflow)
    try:
        result = subprocess.run(
            [
...
def verify_arxiv_id(arxiv_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        req = urllib.request.Request(url, headers={"User-Agent": "create-paper/1.0"})
...
def horus_paper(
    ...
    he has been working on. Combines all create-paper features with
...
This paper was prepared with AI writing assistance using the create-paper skill.
The Horus Lupercal persona was applied for authoritative academic voice.

Tools used: create-paper, scillm (if available)
...
def domains(
    ...
    typer.echo("TIP: Use 'create-paper workflow' to see stage-based recommendations")
