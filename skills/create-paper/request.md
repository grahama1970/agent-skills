...
## Summary
Review the create-paper skill (`paper_writer.py`) - a ~4600 line Python CLI tool that orchestrates academic paper generation through interview-driven workflows, integrating multiple skills (assess, dogpile, arxiv, code-review, scillm, memory, fixture-graph).
