...
def make_compilation_inputs(tmp_path: Path):
    ...
    elements = [
        ...
        },
        {
            ...
            "reference_image_urls": [urls["sb_001.end_frame"], urls["sb_003.start_frame"]],
        },
    ]
    request_input = {
        "prompt": None,
    ...
    provider_snapshot_value = {
        ...
        "ttl_seconds": 86400,
        "schema_source": {
            "requested_url": "https://fal.ai/api",
            "final_url": "https://fal.ai/api",
            "http_status": 200,
        ...
        "pricing_source": {
            "requested_url": "https://fal.ai/pricing",
            "final_url": "https://fal.ai/pricing",
            "http_status": 200,
