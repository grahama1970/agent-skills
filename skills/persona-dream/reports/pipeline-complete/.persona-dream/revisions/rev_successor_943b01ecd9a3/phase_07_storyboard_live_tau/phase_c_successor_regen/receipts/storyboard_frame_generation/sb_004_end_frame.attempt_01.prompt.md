...
PANEL sb_004 ({'end_s': 10, 'start_s': 7.5}): Decisive waterline panel as the clean shoulder stands up over the visible reef boundary.
ACTION: Embry chooses the safe channel and commits only when the lineup opens. The wave, reef, softened wax, and phone obligation converge into one visible decision.
End frame: Embry commits only when the lineup opens, angled toward the safe channel. The phones and obligations remain offscreen but unresolved.
