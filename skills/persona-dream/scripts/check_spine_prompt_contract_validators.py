...
CASES = [
    {
        ...
        "fixture": ROOT / "fixtures/contract/phase01/good_memory_residue_contract.json",
    ...
    },
    {
        ...
        "label": "phase01_bad",
        "validator": ROOT / "scripts/validate_phase01_memory_residue_contract.py",
        "fixture": ROOT / "fixtures/contract/phase01/bad_memory_residue_serialized_json_text.json",
    ...
    },
    {
        ...
        "fixture": ROOT / "fixtures/contract/phase02/good_story_contract_prompt.json",
    ...
    },
    {
        ...
        "label": "phase02_bad",
        "validator": ROOT / "scripts/validate_phase02_story_contract_prompt.py",
        "fixture": ROOT / "fixtures/contract/phase02/bad_story_contract_serialized_memory_blob.json",
    ...
    },
    {
        ...
        "fixture": ROOT / "fixtures/contract/phase06/good_script_prompt_contract.json",
    ...
    },
    {
        ...
        "label": "phase06_bad",
        "validator": ROOT / "scripts/validate_phase06_script_prompt_contract.py",
        "fixture": ROOT / "fixtures/contract/phase06/bad_script_contract_loose_asset_usage.json",
    ...
    },
    {
        ...
        "fixture": ROOT / "fixtures/contract/phase07/good_panel_prompt_contract_sb004.json",
    ...
    },
    {
        ...
        "label": "phase07_bad",
        "validator": ROOT / "scripts/validate_phase07_prompt_contract.py",
        "fixture": ROOT / "fixtures/contract/phase07/bad_prompt_contract_kai_spatially_implied.json",
