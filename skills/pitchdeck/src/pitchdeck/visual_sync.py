...
QDRANT_COLLECTION = "pitchdeck_visual_assets_v1"
MEMORY_COLLECTION = "pitchdeck_visual_assets"
VECTOR_SIZE = 1024
...
def sync_deck_visuals(
    ...
    with httpx.Client(timeout=HTTP_TIMEOUT) as client:
        ...
        for position, image in enumerate(images, start=1):
            ...
            payload = {
                ...
                "tags": ["pitchdeck", "pitchdeck", bundle.deck_id, bundle.visibility],
            }
    ...
    return OperationReceipt(
        schema="pitchdeck.visual_sync_receipt.v1",
