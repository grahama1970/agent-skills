...
class SourceManifest(StrictModel):
    schema_: Literal["pitchdeck.source_manifest.v1"] = Field(
        default="pitchdeck.source_manifest.v1", alias="schema"
    )
...
class ClaimLedger(StrictModel):
    schema_: Literal["pitchdeck.claim_ledger.v1"] = Field(
        default="pitchdeck.claim_ledger.v1", alias="schema"
    )
    project_name: str = Field(min_length=1)
...
class AssetManifest(StrictModel):
    schema_: Literal["pitchdeck.asset_manifest.v1"] = Field(
        default="pitchdeck.asset_manifest.v1", alias="schema"
    )
    project_name: str = Field(min_length=1)
...
class DeckManifest(StrictModel):
    schema_: Literal["pitchdeck.deck_manifest.v1"] = Field(
        default="pitchdeck.deck_manifest.v1", alias="schema"
    )
    deck: DeckMeta
...
class ValidationReport(StrictModel):
    schema_: Literal["pitchdeck.validation_report.v1"] = Field(
        default="pitchdeck.validation_report.v1", alias="schema"
    )
    readiness: Readiness
    errors: int = 0
    warnings: int = 0
