...
Thin CLI entry point - all logic is in modular subpackages.
...
def distill(
    *,
    ...
    Returns:
        Summary dict of what was distilled and stored
    """
    ...
    status_panel("Distill Starting", status_info)
