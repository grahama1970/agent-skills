...
HAS_MEMORY_CLIENT = _HAS_MEMORY  # backward compat alias
...
_BRIDGE_KEYWORDS = {
    ...
    "Resilience": ["generalize", "robust", "fallback", "retry"],
    "Fragility": ["overfit", "collapse", "degenerate", "drift"],
    "Loyalty": ["pipeline", "production", "tier-1.5", "prompt"],
    "Stealth": ["edge case", "ambiguous", "low-confidence"],
}


def extract_bridges(text: str) -> list[str]:
    """Extract taxonomy bridge attributes from prompt content."""
