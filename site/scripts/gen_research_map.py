...
AREAS = [
    {
        ...
        "skill_keywords": ["ask", "tau", "surf", "scillm", "debug", "orchestr", "agent", "dag", "pipeline"],
    },
    {
        "id": "memory",
        "title": "Agentic memory",
        "blurb": "Persistent memory, persona, and retrieval agents can re-query as evidence.",
        "systems": ["persona-dream", "watch", "extractor", "dogpile"],
        "skill_keywords": ["memory", "persona", "dream", "watch", "extract", "dogpile", "retriev", "recall", "arango", "qdrant"],
    },
    {
        "id": "compliance",
        ...
        "skill_keywords": ["sparta", "compliance", "governance", "policy", "audit", "evidence", "oscal"],
    },
    {
        "id": "adaptive-lineage",
        ...
        "systems": ["battle"],
        "skill_keywords": ["battle", "exploit", "red", "blue", "adversar", "security", "cve"],
    },
]
