...
Biology visualizations (violin, volcano, survival, manhattan)
are in bio_visualizations.py. Re-exported here for backward compatibility.
"""
...
def generate_training_curves(
    ...
    if canvas:
        from canvas import matplotlib_to_canvas
        html = matplotlib_to_canvas(title=title, source="/create-figure training-curves")
...
# These functions were moved to bio_visualizations.py but are re-exported
# here so existing imports like `from ml_visualizations import generate_violin_plot`
# continue to work.
from bio_visualizations import (  # noqa: F401, E402
