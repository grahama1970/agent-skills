...
class BatchJob:
    ...
    def start(self) -> bool:
        ...
        cmd = [
            ...
            "--backoff-max", str(self.backoff_max),
            "--whisper",
            "--resume",
        ]
        ...
        try:
            ...
            self.stderr_file = open(log_file, "a")
...
def run(
    ...
    backoff_base: int = typer.Option(5, "--backoff-base", help="Base backoff delay"),
    backoff_max: int = typer.Option(60, "--backoff-max", help="Max backoff delay"),
):
