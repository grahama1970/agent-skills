...
def main(
    ...
    channel: Optional[str] = typer.Option(None, help="Channel name"),
    video: Optional[str] = typer.Option(None, help="Video ID"),
    context: int = typer.Option(1, help="Context segments (default: 1)"),
