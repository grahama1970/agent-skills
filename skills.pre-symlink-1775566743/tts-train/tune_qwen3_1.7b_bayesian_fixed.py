...
def perform_web_research() -> Dict[str, Any]:
    ...
    try:
        ...
        response = httpx.get(hf_url, timeout=10)
...
app = typer.Typer(help="Production-ready Bayesian hyperparameter optimization for Qwen3-TTS 1.7B models")
...
def main(
    ...
    skip_vram_check: bool = typer.Option(False, help=""),
    ...
    try:
        ...
        if not skip_vram_check and model_size == "1.7b":
        ...
        if dataset == "horus":
            ...
            train_jsonl = str(PROJECT_ROOT / "data" / "processed" / dataset / "qwen3_training_data_abs.jsonl")
