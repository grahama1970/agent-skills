"""
Paper Writer Skill - Quality & Verification CLI Commands
Separated from paper_writer.py to keep modules under 800 lines.
"""
import json
import re
...
def register_commands(app: typer.Typer) -> None:
    """Register quality, verification, and compliance commands on the app."""
    ...
    def check_citations_cmd(
        ...
        if not tex_files:
            logger.error(f"No .tex files found in {paper_path}")
            raise typer.Exit(1)
