...
check 0 valid_blocked_catalog_code '{"schema":"pi.agent_status.v1","goal":"g","state":"blocked","blocker":{"triage":{"code":"tau_project_dag_missing_required_evidence","cause":"c"}}}'
check 0 valid_blocked_minted_code '{"schema":"pi.agent_status.v1","goal":"g","state":"blocked","blocker":{"triage":{"code":"unknown_unclassified_953afe1d","cause":"c"}}}'
check 1 illegal_ambiguous_label '{"schema":"pi.agent_status.v1","goal":"g","state":"blocked","blocker":{"triage":{"code":"something went wrong","cause":"c"}}}'
check 1 illegal_freeform_code '{"schema":"pi.agent_status.v1","goal":"g","state":"blocked","blocker":{"triage":{"code":"browser_broke_idk","cause":"c"}}}'
check 1 illegal_blocked_without_triage '{"schema":"pi.agent_status.v1","goal":"g","state":"blocked"}'
